...
public class SMTP1 {
	...
	private static ProtocalState parseInput(String input,ProtocalState currentState){
		//print input first
	...
	private static ProtocalState checkRcptTo(String input,ProtocalState currentState){
	...
	private static ProtocalState checkMailFrom(String input,ProtocalState currentState){
		if(input=="DATA"){
			displayResults(5);
			return currentState;
		}
